...
export function Text(props: TextProps) {
  return <Div style={genStyle(props)}></Div>;
}
Text.Div = function (props: TextProps) {
  return <Div style={genStyle(props)}></Div>;
};
Text.Span = function (props: TextProps) {
  return <Span style={genStyle(props)}></Span>;
};
Text.HeadingOne = function (props: TextProps) {
  return <HeadingOne style={genStyle(props)}></HeadingOne>;
};
Text.Paragraph = function (props: TextProps) {
  return <Paragraph style={genStyle(props)}></Paragraph>;
};
